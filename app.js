...
async function onSuccess(position){
    ...
    const api_key ="{enter your api_key in here}";
...
async function getCountry(country) {
    ...
    try{
        ...
        const respone2 = await fetch('https://restcountries.com/v3.1/alpha?codes=' + countries.toString());
        const neighbors = await respone2.json();
